...
object Color4 {
   private val md_theme_light_primary = Color(0xFF006C4B)
   private val md_theme_light_onPrimary = Color(0xFFFFFFFF)
   private val md_theme_light_primaryContainer = Color(0xFF8AF8C6)
   ...
   private val md_theme_light_onSecondaryContainer = Color(0xFF0A1F16)
   private val md_theme_light_tertiary = Color(0xFF3D6373)
   private val md_theme_light_onTertiary = Color(0xFFFFFFFF)
   private val md_theme_light_tertiaryContainer = Color(0xFFC1E9FB)
   ...
   private val md_theme_light_inversePrimary = Color(0xFF6DDBAB)
   private val md_theme_light_shadow = Color(0xFF000000)
   private val md_theme_light_surfaceTint = Color(0xFF006C4B)
   private val md_theme_light_outlineVariant = Color(0xFFBFC9C1)
   private val md_theme_light_scrim = Color(0xFF000000)
   private val md_theme_dark_primary = Color(0xFF6DDBAB)
   private val md_theme_dark_onPrimary = Color(0xFF003825)
   private val md_theme_dark_primaryContainer = Color(0xFF005138)
   private val md_theme_dark_onPrimaryContainer = Color(0xFF8AF8C6)
   private val md_theme_dark_secondary = Color(0xFFB4CCBD)
   private val md_theme_dark_onSecondary = Color(0xFF1F352A)
   private val md_theme_dark_secondaryContainer = Color(0xFF364B40)
   private val md_theme_dark_onSecondaryContainer = Color(0xFFCFE9D9)
   private val md_theme_dark_tertiary = Color(0xFFA5CCDE)
   private val md_theme_dark_onTertiary = Color(0xFF073543)
   private val md_theme_dark_tertiaryContainer = Color(0xFF244C5B)
   private val md_theme_dark_onTertiaryContainer = Color(0xFFC1E9FB)
   ...
   private val md_theme_dark_onSurfaceVariant = Color(0xFFBFC9C1)
   ...
   private val md_theme_dark_inversePrimary = Color(0xFF006C4B)
   private val md_theme_dark_shadow = Color(0xFF000000)
   private val md_theme_dark_surfaceTint = Color(0xFF6DDBAB)
   private val md_theme_dark_outlineVariant = Color(0xFF404943)
   private val md_theme_dark_scrim = Color(0xFF000000)
   private val seed = Color(0xFF006C4B)
