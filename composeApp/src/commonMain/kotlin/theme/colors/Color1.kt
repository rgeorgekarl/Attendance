...
object Color1 {
    private val md_theme_light_primary = Color(0xFF006973)
    private val md_theme_light_onPrimary = Color(0xFFFFFFFF)
    private val md_theme_light_primaryContainer = Color(0xFF95F1FF)
    ...
    private val md_theme_light_tertiaryContainer = Color(0xFFD9E2FF)
    private val md_theme_light_onTertiaryContainer = Color(0xFF0E1B37)
    ...
    private val md_theme_light_outline = Color(0xFF6F797A)
    private val md_theme_light_inverseOnSurface = Color(0xFFEFF1F1)
    private val md_theme_light_inverseSurface = Color(0xFF2E3132)
    private val md_theme_light_inversePrimary = Color(0xFF4FD8EA)
    private val md_theme_light_shadow = Color(0xFF000000)
    private val md_theme_light_surfaceTint = Color(0xFF006973)
    private val md_theme_light_outlineVariant = Color(0xFFBFC8CA)
    private val md_theme_light_scrim = Color(0xFF000000)
    private val md_theme_dark_primary = Color(0xFF4FD8EA)
    private val md_theme_dark_onPrimary = Color(0xFF00363C)
    private val md_theme_dark_primaryContainer = Color(0xFF004F57)
    private val md_theme_dark_onPrimaryContainer = Color(0xFF95F1FF)
    ...
    private val md_theme_dark_tertiaryContainer = Color(0xFF3A4664)
    private val md_theme_dark_onTertiaryContainer = Color(0xFFD9E2FF)
    ...
    private val md_theme_dark_inversePrimary = Color(0xFF006973)
    private val md_theme_dark_shadow = Color(0xFF000000)
    private val md_theme_dark_surfaceTint = Color(0xFF4FD8EA)
    private val md_theme_dark_outlineVariant = Color(0xFF3F484A)
    private val md_theme_dark_scrim = Color(0xFF000000)
    private val seed = Color(0xFF006974)
