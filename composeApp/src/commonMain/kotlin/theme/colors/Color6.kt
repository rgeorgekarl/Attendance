...
object Color6 {
    private val md_theme_light_primary = Color(0xFF9C4140)
    ...
    private val md_theme_light_secondary = Color(0xFF775654)
    ...
    private val md_theme_light_tertiary = Color(0xFF735A2E)
    private val md_theme_light_onTertiary = Color(0xFFFFFFFF)
    private val md_theme_light_tertiaryContainer = Color(0xFFFFDEA9)
    ...
    private val md_theme_light_inversePrimary = Color(0xFFFFB3AF)
    private val md_theme_light_shadow = Color(0xFF000000)
    private val md_theme_light_surfaceTint = Color(0xFF9C4140)
    private val md_theme_light_outlineVariant = Color(0xFFD7C1C0)
    private val md_theme_light_scrim = Color(0xFF000000)
    private val md_theme_dark_primary = Color(0xFFFFB3AF)
    private val md_theme_dark_onPrimary = Color(0xFF5F1317)
    private val md_theme_dark_primaryContainer = Color(0xFF7E2A2B)
    private val md_theme_dark_onPrimaryContainer = Color(0xFFFFDAD8)
    private val md_theme_dark_secondary = Color(0xFFE7BDBA)
    ...
    private val md_theme_dark_tertiaryContainer = Color(0xFF594319)
    private val md_theme_dark_onTertiaryContainer = Color(0xFFFFDEA9)
    ...
    private val md_theme_dark_inversePrimary = Color(0xFF9C4140)
    private val md_theme_dark_shadow = Color(0xFF000000)
    private val md_theme_dark_surfaceTint = Color(0xFFFFB3AF)
    private val md_theme_dark_outlineVariant = Color(0xFF534342)
    private val md_theme_dark_scrim = Color(0xFF000000)
    private val seed = Color(0xFF9C4140)
