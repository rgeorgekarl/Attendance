...
object Color3 {
    private val md_theme_light_primary = Color(0xFF1960A5)
    private val md_theme_light_onPrimary = Color(0xFFFFFFFF)
    private val md_theme_light_primaryContainer = Color(0xFFD4E3FF)
    private val md_theme_light_onPrimaryContainer = Color(0xFF001C39)
    private val md_theme_light_secondary = Color(0xFF545F71)
    ...
    private val md_theme_light_tertiary = Color(0xFF6D5677)
    private val md_theme_light_onTertiary = Color(0xFFFFFFFF)
    private val md_theme_light_tertiaryContainer = Color(0xFFF6D9FF)
    private val md_theme_light_onTertiaryContainer = Color(0xFF261430)
    ...
    private val md_theme_light_inversePrimary = Color(0xFFA4C9FF)
    private val md_theme_light_shadow = Color(0xFF000000)
    private val md_theme_light_surfaceTint = Color(0xFF1960A5)
    private val md_theme_light_outlineVariant = Color(0xFFC3C6CF)
    private val md_theme_light_scrim = Color(0xFF000000)

    private val md_theme_dark_primary = Color(0xFFA4C9FF)
    private val md_theme_dark_onPrimary = Color(0xFF00315D)
    private val md_theme_dark_primaryContainer = Color(0xFF004883)
    private val md_theme_dark_onPrimaryContainer = Color(0xFFD4E3FF)
    private val md_theme_dark_secondary = Color(0xFFBCC7DB)
    ...
    private val md_theme_dark_tertiary = Color(0xFFD9BDE3)
    private val md_theme_dark_onTertiary = Color(0xFF3D2946)
    private val md_theme_dark_tertiaryContainer = Color(0xFF543F5E)
    private val md_theme_dark_onTertiaryContainer = Color(0xFFF6D9FF)
    ...
    private val md_theme_dark_inversePrimary = Color(0xFF1960A5)
    private val md_theme_dark_shadow = Color(0xFF000000)
    private val md_theme_dark_surfaceTint = Color(0xFFA4C9FF)
    private val md_theme_dark_outlineVariant = Color(0xFF43474E)
    private val md_theme_dark_scrim = Color(0xFF000000)

    private val seed = Color(0xFF1B60A5)
